...
This is an official PyTorch implementation of the "Semi-Supervised Semantic Segmentation via Marginal Contextual Information" paper submission for ICCV 2023.
...
|S4MC     |**70.96**| **71.69**| **75.41**| **77.73**| **80.58**|
